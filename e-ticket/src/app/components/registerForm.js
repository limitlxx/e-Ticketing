...
export default function RegisterForm() {
  return (
    <div className="min-w-[30rem] w-[50%] mx-auto lg:ml-36 my-3 py-3">
      <form>
        <h1 className="text-center md:text-left md:ml-2 mt-5 mb-10 text-2xl text-[#364F6B] font-bold relative">
          Register Event
        </h1>
        ...
        <Link href="/details/register/ticket">
          <button className="bg-[#6d28d9] hover:bg-violet-500 text-white w-[70%] py-3 text-sm rounded-full mx-auto md:ml-2 mt-8 mb-16 block">
            Get Ticket
          </button>
        </Link>
      </form>
