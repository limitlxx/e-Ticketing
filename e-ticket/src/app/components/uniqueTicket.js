        ...
        <div className="max-w-md ml-10 my-8 rounded-xl overflow-hidden md:max-w-2xl">
            ...
            <div class="md:flex">
                <div className="md:shrink-0">
                  <img className="h-48 w-full object-cover md:h-full md:w-[20rem]" src="/image 3.svg" alt="Event image" />
                </div> 
                <div className="pb-4 px-8">
                    <button className=" bg-gray-200 px-7 text-sm mb-4 rounded-xl text-[#5b5959] py-1 font-medium">TICKET</button>
                    <div className="uppercase mb-2 tracking-wide text-sm text-gray-500 font-semibold">NFT permits one individual</div>
                    <h1 class="block mt-1 text-[1.2rem] leading-tight font-bold text-[#364F6B]">How Using VAs & AI Can Help You Boost Productivity And Close More Deals</h1>
